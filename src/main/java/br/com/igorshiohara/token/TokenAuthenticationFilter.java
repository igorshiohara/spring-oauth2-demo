package br.com.igorshiohara.token;
...
import br.com.igorshiohara.auth.AuthenticationService;
...
//	private final String logoutLink;
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if (httpRequest.getHeader(HEADER_USERNAME) != null && httpRequest.getHeader(HEADER_PASSWORD) != null)  {
